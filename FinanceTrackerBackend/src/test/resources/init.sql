...
insert into users (user_id,email, password, first_name, last_name) values (1000,'lahcen','ahtat204','lahcen@asue24.org','lahce33');
...
insert into accounts(account_id,account_name,balance,user_id) values (2000,'testaccount',1346.22,1000);
